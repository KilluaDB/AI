...
def selector_func(messages: Sequence[ChatMessage]) -> str | None:
    ...
    elif "QAAgent" in messages[-1].content:  # These last two should not be needed
    ...
    # Sequential Workflow
        ...
        logger.info(messages[-1])
        return "society_of_mind"
    # elif messages[-1].source == "ConceptualDesignerAgent":  # The selector manages the main group and cannot see this message
