...
from shared.normalization_utils import (
    compute_closure,
    find_candidate_keys,
    get_attribute_keys_by_armstrong as get_attribute_keys_by_arm_strong,
    get_attribute_keys_by_armstrong_single as get_attribute_keys_by_arm_strong_each,
    decompose_to_3nf as decompose_to_3NF,
    get_common_elements as get_common_element_list,
)
...
# NOTE: compute_closure, find_candidate_keys, get_attribute_keys_by_arm_strong, 
# get_attribute_keys_by_arm_strong_each, and get_common_element_list are now imported 
# from shared.normalization_utils


def decompose_to_3NF_legacy(entity_fd_json, entity_primary_keys):
