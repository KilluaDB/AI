...
def get_schema_info(db_config: Dict[str, Any], schema_name: str = 'public') -> Dict[str, List[Dict]]:
    ...
    # logger.info(f"Attempting to connect with DB Config:\n{json.dumps(safe_config, indent=4)}")
    # logger.info(f"Target Schema Name: {schema_name}")
    ...
    # ADD THIS RIGHT HERE (un-indented to match the 'for' loop)
    logger.info(f"Extracted Schema for debugging:\n{json.dumps(schema, indent=4)}")
